...
class Attributes extends ArrayObject {
   ...
   * @param array|string|\Drupal\Core\Template\AttributeValueBase|\Drupal\Core\StringTranslation\TranslatableMarkup $value
  ...
  public function setAttribute($name, $value): void {
    ...
    if ($name === 'class') {
      /** @var array|string|\Drupal\Core\Template\AttributeValueBase $value */
